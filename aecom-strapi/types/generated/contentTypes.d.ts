...
export interface ApiCartItemCartItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variant: Schema.Attribute.Component<'shared.product-variant', false>;
  };
}
...
export interface ApiCheckoutSettingCheckoutSetting
  extends Struct.SingleTypeSchema {
  collectionName: 'checkout_settings';
  info: {
    displayName: 'Checkout Settings';
    pluralName: 'checkout-settings';
    singularName: 'checkout-setting';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::checkout-setting.checkout-setting'
    > &
      Schema.Attribute.Private;
    paymentMethods: Schema.Attribute.Enumeration<['stripe', 'paypal']>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHomepageBannerHomepageBanner
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    homepageBanner: Schema.Attribute.Media<
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    orderItems: Schema.Attribute.Component<'shared.order-item', true>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    images: Schema.Attribute.Component<'shared.image-gallery', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::checkout-setting.checkout-setting': ApiCheckoutSettingCheckoutSetting;
